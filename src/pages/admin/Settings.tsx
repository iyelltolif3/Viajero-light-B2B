              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    {/* Si no existe la estructura adecuada, mostramos inputs por defecto */}
                    {settings?.notifications?.beforeExpiration ? (
                      // Si existe la estructura correcta, mapeamos los días
                      ...
                      // Valor por defecto si no existe la estructura
                      <>
                        <Input 
                          type="number"
                          value={30}
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    id="sectionTitle"
                    value={localSettings?.content?.discountSection?.sectionTitle || ''}
                    onChange={(e) => {
                ...
                <div>
                  ...
                  <Input
                    id="sectionSubtitle"
                    value={localSettings?.content?.discountSection?.sectionSubtitle || ''}
                    onChange={(e) => {
                      setLocalSettings(prev => ({
                        ...prev,
                        content: {
                ...
                <div>
                  ...
                  <Input
                    id="badgeText"
                    value={localSettings?.content?.discountSection?.badgeText || ''}
                    onChange={(e) => {
                      setLocalSettings(prev => ({
                        ...prev,
                        content: {
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={localSettings?.content?.discountSection?.viewAllButtonText || ''}
                    onChange={(e) => {
                      setLocalSettings(prev => ({
                        ...prev,
                        content: {
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        // Crear una copia segura de los descuentos existentes
                        const existingDiscounts = localSettings?.content?.discountSection?.discounts || [];
                  ...
                  {localSettings?.content?.discountSection?.discounts && localSettings.content.discountSection.discounts.length > 0 ? (
                    <div className="space-y-4">
                      {localSettings.content.discountSection.discounts.map((discount, index) => (
